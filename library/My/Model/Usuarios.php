...
{
    protected $_schema 	= 'test_petlocator';
	...
	public function validateUser($datauser){
    	...
    	$sql ="SELECT $this->_primary as ID_USUARIO
	    		FROM $this->_name 
				WHERE adm_usuario  = '".$datauser['usuario']."'
                 AND  adm_clave    = '".$datauser['contrasena']."'";
    ...
    public function getDataUser($idObject){
		...
		$result= Array();
    	$sql ="SELECT $this->_primary as ID_USUARIO,$this->_name.*
				FROM $this->_name
    ...
    public function setLastAccess($datauser){
        ...
        $sql="UPDATE  $this->_name
				SET  adm_fecha_ultimo_ingreso = CURRENT_TIMESTAMP			 
